...
def perform_experiment():
    ...
    cf1.goTo(cf1_start_pos, yaw=0.0, duration=4.0)
    ...
    for i in range(LOOP_ITERS):
        ...
        if USE_JULIA:
            ...
            try:
                (pos_human1,rot_human1) = listener.lookupTransform('/world', '/cf2', rospy.Time(0))
            except (tf.LookupException, tf.ConnectivityException, tf.ExtrapolationException):
                pass
            ...
            x_update = [pos_cf1[0], pos_cf1[1], pos_cf1[2], rot_cf1[3], rot_cf1[0], rot_cf1[1], rot_cf1[2],
                        pos_human1[0],pos_human1[1],pos_human1[2],yaw]
...
if __name__ == '__main__':
    ...
    human1 = swarm.allcfs.crazyflies[1]
    ...
    if USE_JULIA:
        ...
        Main.include("Quadrotor_and_human.jl")
