...
def perform_experiment():
    ...
    for i in range(LOOP_ITERS):
        ...
        if USE_JULIA:
            ...
            xd = Main.Julia_Functions.states(Main.Julia_Functions.altro)[6]
            ...
            cf1.goTo(xd[0:3], yaw=0.0, duration=GOTO_DURATION)
            cf2.goTo(xd[13:16], yaw=0.0, duration=GOTO_DURATION)
            ...
            x_update = [pos_cf1[0], pos_cf1[1], pos_cf1[2], rot_cf1[3], rot_cf1[0], rot_cf1[1], rot_cf1[2],
                        pos_cf2[0], pos_cf2[1], pos_cf2[2], rot_cf2[3], rot_cf2[0], rot_cf2[1], rot_cf2[2],
                        xd_actual[26],xd_actual[27],xd_actual[28],xd_actual[29],
                        xd_actual[30],xd_actual[31],xd_actual[32],xd_actual[33]]
            ...
            if LOG_DATA:
                ...
                csvwriter.writerow([timestampString] +
                                    xd[0:7] + x_update_cf1 + xd_actual[0:7] +
                                   xd[13:20] + x_update_cf2 + xd_actual[13:20])
...
if __name__ == '__main__':
    ...
    if USE_JULIA:
        ...
        Main.include("MPC_Implementation-3.jl")
